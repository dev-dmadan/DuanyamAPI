...
<html lang="en">
    ...
    <body style='font-family:"Bpmonline";'>
        <div class="box box-custom-{{$color ?? 'default'}}">
            ...
            <div class="columns mb-0">
                <div class="column is-half pb-0">
                    <p class="subtitle has-text-{{$color ?? 'default'}} pr-3">
                        {{ $title }} 
                        @if(isset($tooltip) && !empty($tooltip))
                        <span class="has-tooltip-arrow has-tooltip-right has-tooltip-multiline has-tooltip-info" data-tooltip="{{ $tooltip }}"><i class="far fa-question-circle"></i></span>
                        @endif
                    </p>
                </div>
